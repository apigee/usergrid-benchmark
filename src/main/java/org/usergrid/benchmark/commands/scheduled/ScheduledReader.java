 ...
 * 
 */
public class ScheduledReader extends ScheduledBase {

  protected static final Logger readLogger = LoggerFactory.getLogger("read");
  
  protected static final Timer readsTimer = Metrics.newTimer(ScheduledReader.class, "reads", TimeUnit.MILLISECONDS, TimeUnit.SECONDS);
  ...
  protected void doWork(CommandLine line, ScheduledQueue<TestEvent> queue, String hostName, int workers, int count) throws Exception {
    ...
    queue.observe(new TopicListener(latch, readsTimer, readLogger));
